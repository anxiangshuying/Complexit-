...
MdT: liste_sep blanc liste_sep liste_quadruplets liste_sep etat_initial liste_sep ruban liste_sep
	;
...
liste_quadruplets: quadruplet
	| liste_quadruplets liste_sep quadruplet
	;
...
etat_initial: ETAT	{ etat_machine = $1; }
	;

ruban: SYMBOLE		{ ajouter_ruban($1); }
	| ruban SYMBOLE	{ ajouter_ruban($2); }
	;
%%
